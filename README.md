# nyu-travis-ci
[![Build Status](https://travis-ci.com/AnuRam123/nyu-lab-travis-ci.svg?branch=master)](https://travis-ci.com/AnuRam123/nyu-lab-travis-ci)
...
This lab contains a `.travis.yml` file that shows you how to run your tests and request that a Redis service be attached while running them. It also uses Code Coverage to determine how complete your testng is. Is being tested by Anu
HELLO
